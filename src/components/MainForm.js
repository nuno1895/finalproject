...
class MainForm extends Component {
    ...
    return (
      <div className="debtContainer">
        <h1> Food </h1>
          ...
          <button onClick={() => this.setState({section: 'sectionResult'})}>Next</button>
      </div>
    );
  }
  ...
  renderSectionResult() {
    let currentIndex = this.state.currentFormSectionIndex;
    let currentSection = this.state.formSections[currentIndex];
    let formSectionIndex = this.state.formSections.indexOf(currentSection);
    let nextFormIndex = formSectionIndex + 1;
    let nextFormSection = this.state.formSections[nextFormIndex];

    console.log(currentSection);
    console.log(formSectionIndex);
    console.log(nextFormIndex);
    console.log(nextFormSection);
  ...
  renderForm() {
    ...
    else if(this.state.section === 'sectionResult'){
      return this.renderSectionResult();
    }
    else
      return this.renderPay();
  }
...
export default MainForm;
 ...
 //          <button onClick= {() => this.finalResultsRedirect()}>Grade My Budget</button>
 //      </div>
 //    );
 //  }